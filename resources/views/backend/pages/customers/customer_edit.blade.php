...
<div class="col-sm-12" id="edit-customer-container">
  ...
  <div class="card">
    ...
    @include('backend.pages.customers.customer_tab')
      ...
      <div class="col-sm-12 m-t-20 form-tabs">
        ...
        <div class="col-sm-12 tab-content" id="myTabContent">
          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <form action='{{url('admin/edit-customer').'/'.$customerData->id}}' method="post" class="form-horizontal" id="editCustomer">
              ...
              <div class="col-sm-12 px-0">
                ...
                <a href="{{ url('admin/customer/list') }}" class="btn btn-info custom-btn-small">{{ __('Cancel') }}</a>
              </div>
            </form>
          </div>
