  ...
  <div class="col-sm-12" id="departmentAdd-container">
    <div class="card">
      <div class="card-header">
        <h5> <a href="{{url('admin/priorities')}}">{{ __('Priorities List') }}</a> >> {{ __('New Priority') }}</h5>
      ...
      <div class="card-body table-border-style">
        <div class="form-tabs">
          <form action="{{url('admin/create-priority')}}" method="POST" id="priorityAdd" class="form-horizontal">
            @csrf
                ...
                <div class="row">
                  <div class="col-sm-9">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group row">
                            <label class="col-sm-2 control-label require" for="inputEmail3">{{ __('Priority Name') }}</label>
    
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="{{ __('Priority Name') }}"  name="name" value="{{ old('name')}}">
                            </div>
