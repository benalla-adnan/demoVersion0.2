        ...
        <div class="card card-info display_block"">     
            ...
            <div class="card-body"> 
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a href="{{route('admin.language')}}" class="nav-link" aria-selected="true">Languages</a>
                    </li>
                    <li class="nav-item">
                        <a href="" class="nav-link" aria-selected="true">Priorities</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{route('admin.emailConfig')}}" class="nav-link" aria-selected="true">Email Configuration</a>
                    </li>
                    
                    <li class="nav-item">
                        <a href="" class="nav-link" aria-selected="true">Departements</a>
                    </li>
                </ul>
