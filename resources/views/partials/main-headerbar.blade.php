                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <small class="d-none d-md-block font-11">{{$usr->name}}</small>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href=""><i class="ti ti-power font-16 me-1 align-text-bottom"></i> @include('backend.layouts.partials.logout')</a>
                        </div>
