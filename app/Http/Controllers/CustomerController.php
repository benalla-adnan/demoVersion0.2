...
//return $data;
        ...
        return $dataTable->with('row_per_page', $row_per_page)->render('backend.pages.customers.customer_list', $data);
    ...
    public function createCustomer()
    {
        ...
        return view('backend.pages.customers.add-customer', $data);
    }
         ...
         //  return $newCustomer;
          ...
          //  print_r('here'); die;
            ...
            if (!empty($id)) {
                ...
                $newCustomerBranch->name = $request->first_name . ' ' . $request->last_name;
                $newCustomerBranch->billing_street = $request->bill_street;
                $newCustomerBranch->billing_city = $request->bill_city;
                $newCustomerBranch->billing_state = $request->bill_state;
                $newCustomerBranch->billing_zip_code = $request->bill_zipCode;
                $newCustomerBranch->billing_country_id = $request->bill_country_id;
                $newCustomerBranch->shipping_street = $request->ship_street;
                $newCustomerBranch->shipping_city = $request->ship_city;
                $newCustomerBranch->shipping_state = $request->ship_state;
                $newCustomerBranch->shipping_zip_code = $request->ship_zipCode;
    ...
    public function editCustomer($id)
    {
        ...
        return view('backend.pages.customers.customer_edit', $data);
    }
    ...
    public function salesOrder($id)
    {
        ...
        return $this->customerOrderListDataTable->with('row_per_page', $row_per_page)->with('currency', $currency)->with('customer_id', $id)->render('backend.pages.customers.customer_sales_order', $data);
    }
    ...
    public function invoice($id)
    {
        ...
        $row_per_page = Preference::getAll()->where('category', 'preference')->where('field', 'row_per_page')->first('value')->value;
        return $this->customerInvoiceListDataTable->with('row_per_page', $row_per_page)->with('customer_id', $id)->render('backend.pages.customers.customer_invoice', $data);
    }
    ...
    public function invoicePdf()
    {
        ...
        return printPDF($data, 'customer_invoices_list_' . time() . '.pdf', 'backend.pages.customers.customer_invoice_list_pdf', view('backend.pages.customers.customer_invoice_list_pdf', $data), 'pdf', 'domPdf');
    }
    ...
    public function payment($id)
    {
        ...
        return $this->customerPaymentListDataTable->with('row_per_page', $row_per_page)->with('customer_id', $id)->render('backend.pages.customers.customer_payment', $data);
    }
    ...
    public function paymentPdf()
    {
        ...
        return printPDF($data, 'payment_report_' . time() . '.pdf', 'backend.pages.customers.payment_report_pdf', view('backend.pages.customers.payment_report_pdf', $data), 'pdf', 'domPdf');
    }
    ...
    public function updatePassword(Request $request)
    {
        ...
        return redirect()->intended("/edit-customer/" . $id);
    }
    ...
    public function downloadCsv()
    {
        ...
        //         ->get();
        // $customerdata = DB::table('customers') ->leftjoin('customer_branches', 'customers.id', '=', 'customer_branches.customer_id')

        //         ->select('customers.*', 'customer_branches.*')

        //        ->groupBy('customer_branches.customer_id')
        ...
        return Excel::download(new CustomersExport, 'customer_sheet.csv');
    }
    ...
    public function import()
    {
        ...
        return view('backend.pages.customers.customer_import', $data);
    }
    ...
    public function quotationFilterPdf()
    {
        ...
        $data['company_logo'] = Preference::getAll()->where('category', 'company')->where('field', 'company_logo')->first('value');
        return printPDF($data, 'customer_quotation_list' . time() . '.pdf', 'backend.pages.customers.customer_indivisual_quotation', view('backend.pages.customers.customer_indivisual_quotation', $data), 'pdf', 'domPdf');
    }
    ...
    public function project($id)
    {
        ...
        return $this->customerProjectListDataTable->with('row_per_page', $row_per_page)->with('customer_id', $id)->render('backend.pages.customers.customer_project', $data);
    }
    ...
    public function projectPdf()
    {
        ...
        $data['company_logo'] = Preference::getAll()->where('category', 'company')->where('field', 'company_logo')->first('value');
        $data['date_range'] = !empty($from) && !empty($to) ? formatDate($from) . ' To ' . formatDate($to) : 'No Date Selected';
        return printPDF($data, 'projects_list_' . time() . '.pdf', 'backend.pages.customers.customer_projects_pdf', view('backend.pages.customers.customer_projects_pdf', $data), 'pdf', 'domPdf');
    }
    ...
    public function task($id)
    {
        ...
        return $this->customerTaskListDataTable->with('row_per_page', $row_per_page)->with('customer_id', $id)->render('backend.pages.customers.customer_task', $data);
    }
    ...
    public function taskPdf()
    {
        ...
        return printPDF($data, 'tasks_list_' . time() . '.pdf', 'backend.pages.customers.customer_tasks_pdf', view('backend.pages.customers.customer_tasks_pdf', $data), 'pdf', 'domPdf');
    }
    ...
    public function ticket($id)
    {
        ...
        return $this->customerTicketListDataTable->with('row_per_page', $row_per_page)->with('customer_id', $id)->render('backend.pages.customers.customer_ticket', $data);
    }
    ...
    public function ticketPdf()
    {
        ...
        $data['date_range'] = (!empty($from) && !empty($to)) ? formatDate($from) . ' To ' . formatDate($to) : 'No Date Selected';
        return printPDF($data, 'tickets_list_' . time() . '.pdf', 'backend.pages.customers.customer_tickets_pdf', view('backend.pages.customers.customer_tickets_pdf', $data), 'pdf', 'domPdf');
    }
    ...
    public function customerLedger($id)
    {
        ...
        $payment = DB::table('customer_transactions')->join('sale_orders', 'sale_orders.id', '=', 'backend.pages.customers.sale_order_id')->where('backend.pages.customers.customer_id', $id);
    ...
    public function ledegerFilterPdf(Request $request)
    {
        ...
        return printPDF($data, 'customer_ledger_' . time() . '.pdf', 'admin.customer.customer_ledger_pdf', view('backend.pages.customers.customer_ledger_pdf', $data), 'pdf', 'domPdf');
    }
    ...
    public function customerListPdf()
    {
        ...
        return printPDF($data, 'customers_list_' . time() . '.pdf', 'backend.pages.customers.customer_list_pdf', view('backend.pages.customers.customer_list_pdf', $data), 'pdf', 'domPdf');
    }
}
