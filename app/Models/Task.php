...
class Task extends Model
{
    ...
    public function getTaskDetailsById($id)
    {
        $result = DB::table('tasks')
                    ...
                    ->select('tasks.*','priorities.name as priority','priorities.id as priority_id','task_statuses.name as status_name','task_statuses.id as status_id','projects.id as project_id','projects.project_name as project_name','projects.per_hour_project_scale', 'projects.charge_type')
                    ->where('tasks.id',$id)
                    ->first();
        return $result;
    }
