    ...
    public function ajax():JsonResponse
    {
        ...
        return datatables()
            ...
            ->addColumn('action', function ($tasks) {
                ...
                $edit = ($usr->has_permission(Auth::user()->id, 'edit_task')) ? '<a href="' . url("task/edit/". $tasks->id) . '" class="btn btn-xs btn-primary"><i class="feather icon-edit"></i></a>&nbsp;' : '';
                    $delete = ($usr->has_permission(Auth::user()->id, 'delete_task')) ? '
